...
# Lors du remplissage de l'accumulateur on parcours la matrice image N^2 et on la reparcours pour chaque pixel de l'image (N^2)^2=N^4
# Pour une image telle que coins2.png (600px) le temps de calcul est d'environ 2h
# t(100px)^4 => 6s
# (t(100px) * 6)^4 = t(100px)^4 * 6^4
#                  = 6s * 1296
#                  = 7 776s
#                  = 129min 36s = 2h 9min 36s
...
print("Execution time: {} s".format((end_time - start_time) / cv2.getTickFrequency()))
